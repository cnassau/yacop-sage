    ...
    class ParentMethods:
        def cartesian_product(*parents):
            return parents[0].CartesianProduct(
                parents, category=cartesian_product.category_from_parents(parents)
            )
...
class YacopGradedObjects(Category_singleton):
    ...
    class ParentMethods:
        ...
        def graded_basis_coefficients(self, elem, region=None, **kwargs):
            ...
            """
            return self._yacop_grading.basis_coefficients(
                elem, self.__region(region, **kwargs)
            )
        ...
        def nontrivial_degrees(self, region=None, **kwargs):
            ...
            """
            return self._yacop_grading.nontrivial_degrees(
                self.__region(region, **kwargs)
            )
    ...
    class CartesianProducts(CartesianProductsCategory):
        ...
        class ParentMethods:
            def __init_extra__(self):
                self._yacop_grading = cartesian_product(
                    [mod._yacop_grading for mod in self._sets]
                )
...
class SteenrodAlgebraModules(Category_over_base_ring):
    ...
    def __classcall_private__(
        cls, R, is_left=None, is_right=None, is_bimod=None, is_algebra=None
    ):
        if is_left is None:
            is_left = False
        if is_right is None:
        ...
        if is_bimod is None:
            is_bimod = False
        if is_algebra is None:
            is_algebra = False
        if is_bimod:
            is_left = True
            is_right = True
        return super(cls, SteenrodAlgebraModules).__classcall__(
            cls, R, is_left, is_right, is_bimod, is_algebra
        )

    def __init__(self, R, is_left, is_right, is_bimod, is_algebra):
        self._R = R
        self._is_left, self._is_right, self._is_bimod, self._is_algebra = (
            is_left,
            is_right,
            is_bimod,
            is_algebra,
    ...
    class ParentMethods:
        ...
        def __init_extra__(self):
            ...
            if Y._is_left:
                self.register_action(
                    SteenrodAlgebraAction(
                        Y._R, self, self.left_steenrod_action_on_basis, is_left=True
                    )
                )
                self.register_action(
                    SteenrodAlgebraAction(
            ...
            if Y._is_right:
                self.register_action(
                    SteenrodAlgebraAction(
                        Y._R, self, self.right_steenrod_action_on_basis, is_left=False
                    )
                )
                self.register_action(
                    SteenrodAlgebraAction(
    ...
    class _CartesianProducts(CartesianProductsCategory):
        ...
        def super_categories(self):
            ...
            return [
                self.base_category().ModuleCategory(),
            ] + super(SteenrodAlgebraModules._CartesianProducts, obj).super_categories()
...
class YacopLeftModules(SteenrodAlgebraModules):
    def __init__(self, R):
        super(YacopLeftModules, self).__init__(
            R, is_left=True, is_right=False, is_bimod=False, is_algebra=False
        )
...
class YacopRightModules(SteenrodAlgebraModules):
    def __init__(self, R):
        super(YacopRightModules, self).__init__(
            R, is_left=False, is_right=True, is_bimod=False, is_algebra=False
        )
...
class YacopLeftModuleAlgebras(SteenrodAlgebraModules):
    def __init__(self, R):
        super(YacopLeftModuleAlgebras, self).__init__(
            R, is_left=True, is_right=False, is_bimod=False, is_algebra=True
        )


class YacopRightModuleAlgebras(SteenrodAlgebraModules):
    def __init__(self, R):
        super(YacopRightModuleAlgebras, self).__init__(
            R, is_left=True, is_right=True, is_bimod=False, is_algebra=True
        )
...
for cls in (
    ...
    cls.CartesianProducts = make_functor_class(
        cls, "CartesianProducts", SteenrodAlgebraModules._CartesianProducts
    )
    # cls.SuspendedObjects  = make_functor_class(cls,"SuspendedObjects",SteenrodAlgebraModules._SuspendedObjects)
    cls.TensorProducts = make_functor_class(
        cls, "TensorProducts", SteenrodAlgebraModules._TensorProducts
    )
    cls.DualObjects = make_functor_class(
        cls, "DualObjects", SteenrodAlgebraModules._DualObjects
    )
    cls.TruncatedObjects = make_functor_class(
        cls, "TruncatedObjects", SteenrodAlgebraModules._TruncatedObjects
    )
    cls.Subquotients = make_functor_class(
        cls, "Subquotients", SteenrodAlgebraModules._Subquotients
    )
...
def steenrod_algebra_intersect(algebras):
    ...
    for dummy in (0,):
        ...
        # return prof
        res = SteenrodAlgebra(
            A.prime(), generic=isgen, profile=prof, truncation_type=rtrunc
        )
        return res
