...
class YacopBiModules(Category_over_base_ring):
    ...
    EXAMPLES::
        ...
        sage: YacopBiModules(SteenrodAlgebra(7),is_right=True,is_left=False)
    ...
    def ModuleCategory(self):
        ...
        TESTS::
           ...
           sage: from yacop.modules.categories import *
           sage: YacopBiModulesAlgebras(SteenrodAlgebra(3)).ModuleCategory() is YacopBiModules(SteenrodAlgebra(3))
           True
    ...
    class CartesianProducts(CartesianProductsCategory):
        ...
        def super_categories(self):
            ...
            return [self.base_category().ModuleCategory(), ] + super(YacopBiModules._CartesianProducts, obj).super_categories()
...
class YacopBiModulesAlegbras(Category_over_base_ring):
