...
class SteenrodAlgebraModules(Category_over_base_ring):
    ...
    EXAMPLES::
        ...
        sage: SteenrodAlgebraModules(SteenrodAlgebra(7))
    ...
    def _repr_object_names(self):
        ...
        TESTS::
            ...
            sage: from yacop.categories import SteenrodAlgebraModules
    ...
    class CartesianProducts(CartesianProductsCategory):
        ...
        def super_categories(self):
            ...
            """
            obj = self
            return [self.base_category().ModuleCategory(), ] + super(SteenrodAlgebraModules.CartesianProducts, obj).super_categories()
...
class SteenrodAlgebraModulesAlgebras(Category_over_base_ring):
    ...
    def __contains__(self, x):
        ...
        """
        ans = super(SteenrodAlgebraModulesAlgebras, self).__contains__(x)
        if not ans:
            ans = self in x.categories()
        return ans
    ...
    def is_subcategory(self, other):
        ...
        for scat in self.super_categories():
            if scat.is_subcategory(other):
                return True
        return super(SteenrodAlgebraModulesAlgebras, self).is_subcategory(other)
