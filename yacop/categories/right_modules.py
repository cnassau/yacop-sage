...
class YacopRightModules(Category_over_base_ring):
    ...
    EXAMPLES::
        ...
        sage: YacopRightModules(SteenrodAlgebra(7),is_right=True,is_left=False)
    ...
    def ModuleCategory(self):
        ...
        TESTS::
           ...
           sage: from yacop.modules.categories import *
           sage: YacopRightModulesAlgebras(SteenrodAlgebra(3)).ModuleCategory() is YacopRightModules(SteenrodAlgebra(3))
           True
    ...
    class CartesianProducts(CartesianProductsCategory):
        ...
        def super_categories(self):
            ...
            return [self.base_category().ModuleCategory(), ] + super(YacopRightModules._CartesianProducts, obj).super_categories()
...
class YacopRightModulesAlegbras(Category_over_base_ring):
