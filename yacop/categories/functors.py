...
class CombinatorialFreeModules_CartesianProduct_SuspendedObjects(
    CombinatorialFreeModule.CartesianProduct
):
    @staticmethod
...
CombinatorialFreeModule.CartesianProduct.SuspendedObjects = (
    CombinatorialFreeModules_CartesianProduct_SuspendedObjects
)
