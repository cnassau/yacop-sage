...
class YacopLeftModules(Category_over_base_ring):
    ...
    EXAMPLES::
        ...
        sage: YacopLeftModules(SteenrodAlgebra(7),is_right=True,is_left=False)
    ...
    def ModuleCategory(self):
        ...
        TESTS::
           ...
           sage: from yacop.modules.categories import *
           sage: YacopLeftModulesAlgebras(SteenrodAlgebra(3)).ModuleCategory() is YacopLeftModules(SteenrodAlgebra(3))
           True
    ...
    def __fixmecontains__(self, x):
        ...
        hack the following fails::
            ...
            [False, True, True]
        """
        ans = super(YacopLeftModules, self).__contains__(x)
        if not ans:
    ...
    class CartesianProducts(CartesianProductsCategory):
        ...
        def super_categories(self):
            ...
            return [self.base_category().ModuleCategory(), ] + super(YacopLeftModules._CartesianProducts, obj).super_categories()
...
class YacopLeftModulesAlegbras(Category_over_base_ring):
    ...
    def ModuleCategory(self):
        ...
        """
        return YacopLeftModules(self.base_ring())
