...
class YacopLeftModules(Category_over_base_ring):
    ...
    EXAMPLES::
        ...
        Category of yacop left modules over mod 7 Steenrod algebra, milnor basis
    """
    ...
    def _repr_object_names(self):
        ...
        TESTS::
            ...
            Category of yacop left modules over A2
        """
    ...
    def is_subcategory(self, c):
        ...
        TESTS::
            ...
            sage: from yacop.categories import YacopLeftModules, YacopLeftModuleAlgebras
            sage: A=YacopLeftModuleAlgebras(SteenrodAlgebra(2))
            sage: B=YacopLeftModules(SteenrodAlgebra(2,profile=(2,1)))
            sage: C=YacopLeftModuleAlgebras(SteenrodAlgebra(2,profile=(2,1)))
    ...
    class TensorProducts(TensorProductsCategory):
        ...
        def Subquotients(self):
            ...
            TESTS::
                ...
                sage: D=YacopLeftModules(SteenrodAlgebra(3)).TensorProducts()
    ...
    class CartesianProducts(CartesianProductsCategory):
        ...
        TESTS::
            ...
            sage: from yacop.categories.left_modules import YacopLeftModules
            sage: D=YacopLeftModules(SteenrodAlgebra(3)).CartesianProducts() ; D
            Category of Cartesian products of yacop left modules over mod 3 Steenrod algebra, milnor basis
        ...
        def Subquotients(self):
            ...
            TESTS::
                ...
                sage: from yacop.categories.left_modules import YacopLeftModules
                sage: D=YacopLeftModules(SteenrodAlgebra(3)).CartesianProducts()
                sage: D in D.Subquotients().all_super_categories()
                False
                sage: from sage.categories.groups import Groups
                sage: from sage.categories.category_types import JoinCategory
...
class YacopLeftModuleAlgebras(Category_over_base_ring):
    def super_categories(self):
        ...
        TESTS::
            ...
            [Category of yacop left modules over mod 5 Steenrod algebra, milnor basis,
    ...
    class CartesianProducts(YacopLeftModules.CartesianProducts):
        pass
